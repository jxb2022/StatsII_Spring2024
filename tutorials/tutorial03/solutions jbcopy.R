...
#  Create a null model - the intercept - "mean" 
nullMod <- glm(hsgrad ~ 1, # 1 = fit an intercept only (i.e. sort of a "mean") graduation rate when no other variables are in the model
               data = graduation, 
               family = "binomial")
# binomial logit link is by default (in this instance)
...
## The siblings and income are INSIGNIFICANT - lareger the red bar the more significant
## The probability is easier to check wit hte larger range of coefficients
